...
!function (t, e) {
  ...
  y.prototype.eventElement = function (t) {
    ...
    return e || (e = new X(t), this.eventElements.push(e)),
    e
  },
  ...
  T = function (t) {
    ...
    !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = p(t, u(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = u((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth)))  : t.scrollbarXActive = !1,
    ...
    wheel: function (e) {
      ...
      function l(e, i, r) {
        ...
        for (var l = e; l && l !== o; ) {
          ...
          if ([n.overflow,
          n.overflowX,
          n.overflowY].join('').match(/(scroll|auto)/)) {
